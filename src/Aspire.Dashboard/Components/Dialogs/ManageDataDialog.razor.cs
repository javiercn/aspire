...
public partial class ManageDataDialog : IDialogContentComponent, IAsyncDisposable
{
    ...
    private static TelemetryDataRow CreateTelemetryDataRow(AspireDataType dataType, string resourceName)
    {
        ...
        {
            AspireDataType.ResourceDetails => new TelemetryDataRow { DataType = AspireDataType.ResourceDetails, Icon = new Octicons.Size16.ContentView(), Url = DashboardUrls.ResourcesUrl(resource: resourceName) },
            AspireDataType.ConsoleLogs => new TelemetryDataRow { DataType = AspireDataType.ConsoleLogs, Icon = new Octicons.Size16.SlideText(), Url = DashboardUrls.ConsoleLogsUrl(resource: resourceName) },
            AspireDataType.StructuredLogs => new TelemetryDataRow { DataType = AspireDataType.StructuredLogs, Icon = new Octicons.Size16.SlideTextSparkle(), Url = DashboardUrls.StructuredLogsUrl(resource: resourceName) },
            AspireDataType.Traces => new TelemetryDataRow { DataType = AspireDataType.Traces, Icon = new Octicons.Size16.GanttChart(), Url = DashboardUrls.TracesUrl(resource: resourceName) },
            AspireDataType.Metrics => new TelemetryDataRow { DataType = AspireDataType.Metrics, Icon = new Octicons.Size16.ChartMultiple(), Url = DashboardUrls.MetricsUrl(resource: resourceName) },
